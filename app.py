...
location_method = st.sidebar.radio("Select method:", ["Drop pin on map", "Enter address/postal code", "Enter coordinates", "📍 Use My Location"])
...
tabs = st.tabs(["Map View", "Compare Parkings"])
